...
const techdesc = {
    ...
    NextJS: "I have not created any projects with NextJS but am familiar and am able to use its main features including SEO, server side rendering, and pages",
    Supabase: "My knowledge of Supabase is limited for now, but I am able to use it for basic use cases such as authentication, data fetching, and updating data",
};
